...
/** Invokes the CreateAllThumbs comments command.
...
*/
void InvokeCreateAllThumbsCmdSnip()
{
	ASAtom cmdName;
	...
	DURING
		...
		cmdName = ASAtomFromString(kAVCommandEmbedAllThumbs);
	...
	Console::displayString("Create All Thumbs Cmd invoked\n");
}

SNIPRUN_REGISTER(InvokeCreateAllThumbsCmdSnip, "AV Layer:Commands:Invoke CreateAllThumbs Cmd", "Invokes the CreateAllThumbs command.")
