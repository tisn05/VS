...
namespace ZXing.QrCode.Internal
{
   ...
   public sealed class ErrorCorrectionLevel
   {
      ...
      public static readonly ErrorCorrectionLevel L = new ErrorCorrectionLevel(0, 0x00, "L");
      /// <summary> M = ~15% correction</summary>
      public static readonly ErrorCorrectionLevel M = new ErrorCorrectionLevel(1, 0x01, "M");
      /// <summary> Q = ~25% correction</summary>
      public static readonly ErrorCorrectionLevel Q = new ErrorCorrectionLevel(2, 0x02, "Q");
      /// <summary> H = ~30% correction</summary>
      public static readonly ErrorCorrectionLevel H = new ErrorCorrectionLevel(3, 0x03, "H");
