    ...
    public static class Encoder
    {
                                  ...
                                  IDictionary<EncodeHintType, object> hints)
        {
         ...
         bool generateECI = (hints != null && hints.ContainsKey(EncodeHintType.CHARACTER_SET));
            ...
            if (hints.ContainsKey(EncodeHintType.VERSION) )
            {
                Version tmpVersion = (Version)hints[EncodeHintType.VERSION];
                if (hints[EncodeHintType.VERSION] != null && tmpVersion.VersionNumber > version.VersionNumber){
                    version = tmpVersion;
                }
            }
