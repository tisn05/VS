namespace Zhangyue.iReader.EBK3
{
    ...
    public class Ebk3_Data
    {
        ...
        private static int[] pbk_sys_crc16_ccitt_table = new int[] { 
        ...
        {
            return (int) (((holdrand = (holdrand * 0x343fdL) + 0x269ec3L) >> 0x10) & 0x7fffL);
        }
        ...
        public byte[] pbk_sys_data_decode(byte[] data, int key)
        {
            ...
            {
                byte num6 = data[i];
                byte num7 = (byte) this.pbk_data_n();
                num6 ^= num7;
                num6 = (byte) ~num6;
                byte num3 = (byte)(num6 & 0xc0);
                byte num4 = (byte)(num6 & 0x38);
                byte num5 = (byte)(num6 & 7);
                data[i] = (byte)(((num5 << 5) | (num4 >> 1)) | (num3 >> 6));
            }
            return data;
        }
        ...
        public byte[] pbk_sys_data_encode(byte[] data, int key)
        {
            ...
            {
                byte num3 = data[i];
                byte num4 = (byte)(num3 & 0xe0);
                byte num5 = (byte)(num3 & 0x1c);
                byte num6 = (byte)(num3 & 3);
                byte num7 = (byte) this.pbk_data_n();
                num3 = (byte)(((num6 << 6) | (num5 << 1)) | (num4 >> 5));
                num3 = (byte) ~num3;
                data[i] = (byte)(num3 ^ num7);
            }
            return data;
        }
        ...
        public int pbk_sys_get_crc16_value(byte[] data)
        {
            ...
            {
                num = (num >> 8) ^ pbk_sys_crc16_ccitt_table[(num ^ data[num2++]) & 0xff];
            }
            num ^= 0xffff;
            return (num & 0xffff);
        }
