namespace Zhangyue.iReader.EBK3
{
    ...
    public class GetEbk3HeadArray
    {
        public object[] infomodelarray(EBK3HeadInfoModel infomodel)
        {
            ...
            model.bytename9 = Encoding.Unicode.GetBytes(infomodel.name9);
            objArray[8] = model.bytename9;
            model.byteauthor10 = Encoding.Unicode.GetBytes(infomodel.author10);
            objArray[9] = model.byteauthor10;
            model.bytesubject11 = Encoding.Unicode.GetBytes(infomodel.subject11);
            objArray[10] = model.bytesubject11;
            model.bytepublisher12 = Encoding.Unicode.GetBytes(infomodel.publisher12);
